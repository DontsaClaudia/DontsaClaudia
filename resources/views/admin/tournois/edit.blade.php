    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tournois.update", [$tournoi->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom_tournoi') ? 'is-invalid' : '' }}" type="text" name="nom_tournoi" id="nom_tournoi" value="{{ old('nom_tournoi', $tournoi->nom_tournoi) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_equipes') ? 'is-invalid' : '' }}" type="number" name="nombre_equipes" id="nombre_equipes" value="{{ old('nombre_equipes', $tournoi->nombre_equipes) }}" step="1" required>
